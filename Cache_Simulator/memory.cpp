...
void textSectionClass::WriteByte(unsigned int index, bitset<8> data){
...
bitset<8> textSectionClass::ReadByte(unsigned int index){
  bitset<8> a=0;
   if (index >= mem.size()) {
    return a;
  } else {
...
void dataSectionClass::WriteByte(unsigned int index, bitset<8> data){
...
bitset<8> dataSectionClass::ReadByte(unsigned int index){
  bitset<8> a=0;
   if (index >= mem.size()) {
    return a;
  } else {
...
void stackSectionClass::WriteByte(unsigned int index, bitset<8> data){
...
bitset<8> stackSectionClass::ReadByte(unsigned int index){
  bitset<8> a=0;
   if (index >= mem.size()) {
    return a;
  } else {
