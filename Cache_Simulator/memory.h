...
public:
  ...
  void WriteByte(unsigned int index , bitset<8> data);
  bitset<8> ReadByte(unsigned int index);
...
public:
  ...
  void WriteData(int n, unsigned int address, bitset<64> value);
  void writeData(int n, long int value);
  void WriteByte(unsigned int address , bitset<8> data);
  bitset<8> ReadByte(unsigned int address);
  void writeInstruction(string s);
  bitset<32> readInstruction(unsigned int pc);
